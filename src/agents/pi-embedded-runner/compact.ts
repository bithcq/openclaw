...
export async function compactEmbeddedPiSessionDirect(
  ...
  try {
    ...
    // baseUrl 走模型原生 web_search：移除本地 web_search 工具，避免走 tools/web-search.ts。
    ...
    try {
      ...
      if (useNativeWebSearchForBaseUrl) {
        // 压缩链路与主链路保持一致，统一使用原生 web_search。
